...
import { createUserWithEmailAndPassword, updateProfile, GoogleAuthProvider, signInWithPopup, sendEmailVerification } from 'firebase/auth' // Firebase logic
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 sm:p-10 shadow-sm">
            ...
            <button
              ...
              disabled={loading}
              className="w-full btn-shimmer text-white font-semibold py-3.5 rounded-xl text-sm mb-5 disabled:opacity-60"
            >
